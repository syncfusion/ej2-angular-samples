...
export const mapAppRoutes: Object[] = [
    ...
    { path: ':theme/maps/legend', component: MapsLegendComponent, name: "Grouping countries", order: "02", category: "Features", description: 'This demo for Essential JS2 Maps control visualizes grouping of countries in the legend based on its population density.' },
    ...
    { path: ':theme/maps/tooltip', component: MapsTooltipComponent, name: "Tooltip", order: "03", category: "User Interaction", description: 'This demo for Essential JS2 Maps control depicts the countries that were appeared in the finals of Cricket World Cup and their counts.' },
    { path: ':theme/maps/selection', component: MapsSelectionComponent, name: "Selection & Highlight", order: "03", category: "User Interaction", description: 'This demo for Essential JS2 Maps control visualizes USA president election results in the year 2016. Default and interactive are the two types of legend.' },
    { path: ':theme/maps/zooming', component: MapsZoomingComponent, name: "Zooming & Panning", order: "03", category: "User Interaction", description: 'This demo for Essential JS2 Maps control depicts the properties required to zoom and pan the rendered map.' },
    { path: ':theme/maps/drilldown', component: MapsDrilldownComponent, name: "Drill Down", order: "03", category: "User Interaction", description: 'This demo for Essential JS2 Maps control demonstrates drill down with all the continents in the initial view and countries on drill.' },
    { path: ':theme/maps/print', component: MapsPrintComponent, name: "Print", order: "04", category: "Print and Export", description: 'This demo for Essential JS2 Maps control illustrates the printing functionality in the maps control.' },
    { path: ':theme/maps/export', component: MapsExportComponent, name: "Export", order: "04", category: "Print and Export", description: 'This demo for Essential JS2 Maps control illustrates the exporting functionality in the maps control.' },
    { path: ':theme/maps/heatmap', component: MapsHeatmapComponent, name: "Heat Map", order: "05", category: "Use Cases", description: 'This demo for Essential JS2 Maps control visualizes the state wise population of India in the year 2011. Color for states will be applied based on its value.'  },
    { path: ':theme/maps/curved-lines', component: MapsCurvedLinesComponent, name: "Flight routes", order: "05", category: "Use Cases", description: 'This demo for Essential JS2 Maps control demonstrates the flight routes from India to China using navigation lines feature.'  },
    { path: ':theme/maps/earthquake', component: MapsEarthquakeComponent, name: "Earthquake indication", order: "05", category: "Use Cases", description: 'This demo for Essential JS2 Maps control demonstrates the earth quack occurred in Sumatra, Indonesia in the year 2009.'  },
    { path: ':theme/maps/highlight', component: MapsHighlightComponent, name: "Highlighted Region", order: "05", category: "Use Cases", description: 'This demo for Essential JS2 Maps control depicts the ATM populated areas in Oklahoma by highlighting the regions.'  },
    { path: ':theme/maps/pie', component: MapsPieComponent, name: "Map with Pie chart", order: "05", category: "Use Cases", description: 'This demo for Essential JS2 Maps control visualizes the placing of pie charts on the maps using marker templates.'  },    
    { path: ':theme/maps/seat-selection', component: MapsSeatSelectionComponent, name: "Bus seat booking", order: "05", category: "Use Cases", description: 'This demo for Essential JS2 Maps control demonstrates the rendering of normal geometry type shapes on the map.'  }
];
