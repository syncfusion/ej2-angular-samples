...
export const mapAppRoutes: Object[] = [
    ...
    { path: ':theme/maps/legend', component: MapsLegendComponent, name: "Legend", type: 'update', order: "02", category: "Features", description: 'This demo for Essential JS2 Maps control visualizes grouping of countries in the legend based on its population density.' },
    { path: ':theme/maps/color-mapping', component: ColorMappingComponent, name: "Color Mapping", type: 'new', order: "02",  category: "Features", description: 'This demo for Essential JS2 Maps with color mapping.' },
    ...
    { path: ':theme/maps/osm', component: MapsOsmComponent, name: 'OpenStreetMap', type: 'new', order: '03', category: 'Map Providers',  description: 'This demo for Essential JS2 Maps control depicts the osm sample.' },
    { path: ':theme/maps/osm-with-navigation-lines', component: MapsOsmWithNavigationComponent, name: 'OSM with Navigation Lines', type: 'new',  order: '03', category: 'Map Providers', description: 'This demo for Essential JS2 Maps control depicts the flight route from Los Angeles to Mexico City using navigation lines in the OpenStreetMap..' },
    { path: ':theme/maps/osm-with-sublayers', component: MapsOsmWithSublayerComponent, name: 'OSM with Sublayer', order: '03', type: 'new', category: 'Map Providers', description: 'This demo for Essential JS2 Maps control depicts the flight route from Los Angeles to Mexico City using navigation lines in the OpenStreetMap.' },
    ...
    { path: ':theme/maps/map-with-slider', component: MapsWithSliderComponent, name: "Map with Slider", type: 'new', order: "06",  category: "Use Cases", description: 'This demo for Essential JS2 Maps control visualizes the maps using slider.'  },
