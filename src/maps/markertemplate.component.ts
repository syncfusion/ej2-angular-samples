...
import { MapsTheme, Maps, Marker, ILoadEventArgs } from '@syncfusion/ej2-ng-maps';
...
@Component({
    ...
    templateUrl: 'markertemplate.html',
            ...
            markerSettings: [
                {
                    ...
                    width: 30,
                    visible: true,
                    template: '<div id="marker1" style="font-size: 14px;height:30px; width:30px;"><img class="markerTemplate" src="src/maps/images/weather-clear.png"/>' +
                ...
                },
                {
                    ...
                    width: 30,
                    visible: true,
                    template: '<div id="marker1" style="font-size: 14px;height:30px; width:30px;"><img class="markerTemplate" src="src/maps/images/weather-clouds.png"/>' +
                    '<p>{{:Name}}:{{:Temperature}}°C</p></div>',
                    dataSource: [
                ...
                },
                {
                    ...
                    width: 30,
                    visible: true,
                    template: '<div id="marker1" style="font-size: 14px;height:30px; width:30px;"><img class="markerTemplate" src="src/maps/images/weather-rain.png"/>' +
                    '<p>{{:Name}}:{{:Temperature}}°C</p></div>',
                    dataSource: [
