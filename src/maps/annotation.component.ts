...
import { MapsTheme, Maps, Annotations, Marker, ILoadEventArgs } from '@syncfusion/ej2-ng-maps';
    ...
    public annotations: object[] = [
        {
            ...
            content: '<div id="compass-maps"> <img src="src/maps/images/compass.svg" width="75px" height="75px"> </div>',
            x: '85%', y: '5%'
        }
    ];
