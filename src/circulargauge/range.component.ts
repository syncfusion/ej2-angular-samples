...
export class RangeComponent {
    ...
    document.getElementById('rangeColor').onchange = () => {
        let index: number = +(<HTMLInputElement>document.getElementById('rangeSelect')).value;
        this.circulargauge.axes[0].ranges[index].color = (<HTMLInputElement>document.getElementById('rangeColor')).value;
        this.circulargauge.axes[0].pointers[0].animation.enable = false; this.circulargauge.refresh();
    };
    ...
    document.getElementById('rangeSelect').onchange = () => {
        let index: number = +(<HTMLInputElement>document.getElementById('rangeSelect')).value;
        (<HTMLInputElement>document.getElementById('rangeColor')).value = this.circulargauge.axes[0].ranges[index].color;
