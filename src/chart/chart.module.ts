...
export const chartAppRoutes: Object[] = [
 ...
 order: '01', category: 'Line Charts' },
    ...
    { path: ':theme/chart/stacked-area-100', component: PercentStackedAreaChartComponent, name: '100% Stacked Area', description: "This demo for Essential JS2 Chart control shows how to render the 100 percent stacking area series.", order: '02', category: 'Area Charts' },
    ...
    { path: ':theme/chart/stacked-column-100', component: PercentStackedColumnChartComponent, name: '100% Stacked Column', description: "This demo for Essential JS2 Chart control shows how to render the 100 percent stacking column series.", order: '03', category: 'Bar Charts' },
    ...
    { path: ':theme/chart/stacked-bar100', component: PercentStackedBarChartComponent, name: '100% Stacked Bar', description: "This demo for Essential JS2 Chart control shows how to render the 100 percent stacking bar series.", order: '03', category: 'Bar Charts' },
    ...
    { path: ':theme/chart/pie-radius', component: PieRadiusComponent, name: 'Pie with Various Radius', description: "This demo for Essential JS2 Chart control shows how to render and configure the pie chart with different radius.", order: '09', category: 'Accumulation Charts', type: 'new' },
    ...
    { path: ':theme/chart/lazy-loading', component: LazyLoadingComponent, name: 'Lazy Loading', description: "This demo for Essential JS2 Chart control demonstrates the Lazy Loading behavior in chart.", order: '11', category: 'Data Binding', type: 'New' },
...
@NgModule({
    imports: [chartRouter, ChartAllModule, RangeNavigatorAllModule, SharedModule, ButtonModule, AccumulationChartAllModule,
        NumericTextBoxModule, DatePickerModule],
    exports: [],
