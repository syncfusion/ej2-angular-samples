...
export const scheduleRouteConfig: Object[] = [
    ...
    { 'path': ':theme/schedule/calendar-integration', component: CalendarIntegrationComponent, name: 'Sync Google Calendar', type: 'new', order: '02', category: 'Appointments', description: 'This example shows how to integrate Google Calendar events into Angular Scheduler.' },
    ...
    { 'path': ':theme/schedule/block-events', component: BlockEventsComponent, name: 'Blocking Dates and Time', type: 'new', order: '03', category: 'Appointments', description: 'This example shows how to block specific days or time intervals on Angular Scheduler.' },
    ...
    { 'path': ':theme/schedule/external-drag-drop', component: ExternalDragDropComponent, name: 'External Drag and Drop', type: 'new', order: '03', category: 'Appointments', description: 'This example shows how to drag and drop the events from an external source into Angular scheduler.' },
    { 'path': ':theme/schedule/virtual-scrolling', component: VirtualScrollingComponent, name: 'Virtual Scrolling', type: 'new', order: '04', hideOnDevice: true, category: 'Scrolling', description: 'This example illustrates how to enable the virtual loading of resources and its events in Angular Scheduler.' },
    ...
    { 'path': ':theme/schedule/timeline-resource', component: TimelineResourcesComponent, name: 'Room Scheduler', type: 'update', order: '06', category: 'Multiple Resources', description: 'This demo for Essential JS2 Scheduler control shows how to design the room scheduling calendar and manage the events booked on a particular time interval.' },
    ...
    { 'path': ':theme/schedule/timeline-resource-grouping', component: TimelineResourceGroupingComponent, name: 'Timeline Grouping ', type: 'update', order: '07', category: 'Resource Grouping', description: 'This demo for Essential JS2 Scheduler control shows how the calendars of multiple resources are grouped in timeline view layouts.' },
    ...
    { 'path': ':theme/schedule/time-scale', component: TimescaleComponent, name: 'Timescale', order: 'q0', category: 'Customization', description: 'This demo for Essential JS2 Scheduler control shows how to customize the grid lines of scheduler with different duration and count.' },
    { 'path': ':theme/schedule/context-menu', component: ScheduleContextMenuComponent, name: 'Context Menu', order: '10', type: 'new', category: 'Customization', description: 'This example shows how to enable the context menu on Angular Scheduler and perform the related actions using menu options.' },
    ...
    { 'path': ':theme/schedule/read-only', component: ReadOnlyComponent, name: 'Read-only Events', type: 'update', order: '10', category: 'Customization', description: 'This demo for Essential JS2 Scheduler control shows how to make specific events on the scheduler to be displayed in a read-only mode.' },
    ...
    { 'path': ':theme/schedule/keyboard-interaction', component: KeyboardComponent, name: 'Keyboard Interaction', order: '12', category: 'Miscellaneous', description: 'This demo for Essential JS2 Scheduler control showcases the keyboard shortcuts available on scheduler.' },
...
let declarations: Type<Object>[] = [DefaultComponent, ScrollTimeComponent, TooltipComponent, EditorValidationComponent, KeyboardComponent, EventsComponent,
    BlockEventsComponent, RecurrenceComponent, TimezoneComponent, ViewsComponent, MonthAgendaComponent, ViewConfigComponent, AgendaComponent,
    ...
    ResourcesComponent, GroupComponent, AddRemoveResourcesComponent, TimelineComponent, TimelineResourceGroupingComponent,
    TimelineResourcesComponent, HeaderRowsComponent, ExternalDragDropComponent, ScheduleContextMenuComponent, VirtualScrollingComponent,
