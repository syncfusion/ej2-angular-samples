...
export class VirtualizationListViewComponent {
    ...
    public ngOnInit() {
        this.commonData = [
            ...
            { name: 'Margaret', imgUrl: './src/list-view/images/margaret.png', id: '3' },
            { name: 'Steven', icon: 'S', id: '4' },
            { name: 'Laura', imgUrl: './src/list-view/images/laura.png', id: '5' },
            { name: 'Robert', icon: 'R', id: '6' },
            { name: 'Michael', icon: 'M', id: '7' },
            { name: 'Albert', imgUrl: './src/list-view/images/albert.png', id: '8' },
