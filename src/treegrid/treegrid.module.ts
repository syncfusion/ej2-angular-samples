...
import { ConditionalFormattingComponent } from './conditionalformatting';
...
let declarations: Type<Object>[] = [DefaultComponent, LocalDataComponent, RemoteData, SelfReferenceComponent, SortComponent, SortingAPIComponent, Page, PagingAPIComponent, ContextMenuComponent, CustomContextMenuComponent, AggregateComponent, CustomAggregateComponent, ColumnReorderComponent, ColumnFormattingComponent, ColumnTemplateComponent, ResizingComponent,
    ...
    GridLinesComponent, RowHover, RowHeightComponent, FilteringMenuComponent, SelectionComponent, SelectionAPIComponent];
