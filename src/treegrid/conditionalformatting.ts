...
export class ConditionalFormattingComponent implements OnInit {
    ...
    queryCellInfo (args: QueryCellInfoEventArgs) {
        if (args.cell.innerHTML === 'High') {
            ...
            x.setAttribute('src', 'src/app/treegrid/images/High.png');
            ...
            y.setAttribute('src', 'src/app/treegrid/images/Critical.png');
            ...
            z.setAttribute('src', 'src/app/treegrid/images/Low.png');
            ...
            a.setAttribute('src', 'src/app/treegrid/images/Normal.png');
