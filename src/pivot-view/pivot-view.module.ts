...
export const pivotviewRouteConfig: Object[] = [
    ...
    { 'path': ':theme/pivot-view/field-list', 'description': 'This demo for Essential JS2 Pivot Table control demonstrate the field list feature of the pivotgrid widget, field list allows the user to rearrange the fields between different axes, including column, row, value, and filter along with filter and sort options', component: FieldListComponent, 'name': 'Field List', order: '03', category: 'User Interaction', 'type': 'update' },
    { 'path': ':theme/pivot-view/grouping-bar', 'description': 'This demo for Essential JS2 Pivot Table control demonstrate the grouping bar feature of the pivotgrid widget, grouping bar allows the user to rearrange the fields between different axes, including column, row, value, and filter along with filter and sort options', component: GroupingBarComponent, 'name': 'Grouping Bar', order: '03', category: 'User Interaction' },
    ...
    { 'path': ':theme/pivot-view/summary-customization', 'description': 'This demo for Essential JS2 Pivot Table control demonstrate the summary customization feature of the pivotgrid widget', component: SummaryCustomizationComponent, 'name': 'Show/Hide Totals', order: '03', category: 'User Interaction', 'type': 'new' },
    { 'path': ':theme/pivot-view/calculated-field', 'description': 'This demo for Essential JS2 Pivot Table control shows calculated field, and it allows users to add calculated items either through a dialog window at run time or through code behind', component: CalculatedFieldComponent, 'name': 'Calculated Field', order: '04', category: 'Formula' },
    { 'path': ':theme/pivot-view/aggregation', 'description': 'This demo for Essential JS2 Pivot Table control shows different types of aggregation for value fields', component: AggregationComponent, 'name': 'Aggregation', order: '04', category: 'Formula', 'type': 'update' },
    ...
    { 'path': ':theme/pivot-view/value-sorting', 'description': 'This demo for Essential JS2 Pivot Table control shows sorting values on column or row wise', component: ValueSortingComponent, 'name': 'Value Sorting', order: '05', category: 'Sorting' },
    ...
    { 'path': ':theme/pivot-view/chart', 'description': 'This demo for Essential JS2 Pivot Table control demonstrate integration of pivot table data into a simple chart widget', component: ChartComponent, 'name': 'Chart', order: '07', category: 'Integration' },
    ...
    { 'path': ':theme/pivot-view/drill-through', 'description': 'This demo for Essential JS2 Pivot Table control shows the raw items of any value cells in pivot grid', component: DrillThroughComponent, 'name': 'Drill Through', 'order': '09', 'category': 'Miscellaneous', 'type': 'new' },
    { 'path': ':theme/pivot-view/editing', 'description': 'This demo for Essential JS2 Pivot Table control allows to edit, add and delete the value cells in pivot grid', component: EditingComponent, 'name': 'Editing', 'order': '09', 'category': 'Miscellaneous', 'type': 'new' },
    { 'path': ':theme/pivot-view/hyper-link', 'description': 'This demo for Essential JS2 Pivot Table control shows hyperlink option on cells of the pivotgrid widget', component: HyperLinkComponent, 'name': 'Hyperlink', order: '09', category: 'Miscellaneous', 'type': 'new' },
    { 'path': ':theme/pivot-view/defer-update', 'description': 'This demo for Essential JS2 Pivot Table control demonstrate defer layout update feature of the pivotgrid widget', component: DeferUpdateComponent, 'name': 'Defer Layout Update', order: '09', category: 'Miscellaneous', 'type': 'new' },
    { 'path': ':theme/pivot-view/exporting', 'description': 'This demo for Essential JS2 Pivot Table control demonstrate client-side exporting of the pivotgrid widget to Excel, CSV and PDF formats', component: ExportingComponent, 'name': 'Export', order: '09', category: 'Miscellaneous' }
];
...
let declarations: Type<Object>[] = [DefaultComponent, LocalComponent, RemoteComponent, GroupingBarComponent, FieldListComponent, CalculatedFieldComponent,
    ...
    FilteringComponent, LabelFilterComponent, ValueFilterComponent, ConditionalFormattingComponent, VirtualScrollingComponent, HyperLinkComponent, DeferUpdateComponent, SummaryCustomizationComponent];
