...
import { NumericTextBoxModule, ColorPickerModule, UploaderModule } from '@syncfusion/ej2-angular-inputs';
...
import { ComplexShapesDiagramComponent } from './complexshapes.component';
import { FishboneDiagramComponent } from './fishbone.component'
...
import { UserHandlediagramComponent } from './userhandle.component';
...
import { BPMNShapesDiagramComponent } from './bpmn-shapes.component';
...
import { OrganizationalChartDiagramComponent } from './organizationalchart.component';
import { RadialTreeDiagramComponent } from './radial-tree.component';
import { MindMapDiagramComponent } from './mind-map.component';
import { SymmetricLayoutDiagramComponent } from './symmetriclayout.component';
...
import { RTLTreeDiagramComponent } from './rtl-tree.component';
...
export const diagramAppRoutes: Object[] = [
    ...
    {
        path: ':theme/diagram/bpmn-shapes', component: BPMNShapesDiagramComponent,
        name: 'BPMN Editor', category: 'Getting Started', order: '01', type: 'new',
        description: 'This sample visualizes the hotel booking reservation system and its built with readymade BPMN shapes.',
    },
    {
        path: ':theme/diagram/complexshapes', component: ComplexShapesDiagramComponent,
        name: 'Complex Shapes',
        category: 'Getting Started', order: '01',
    ...
    },
    {
        ...
        name: 'Drawing Tools',
        category: 'User Interaction', order: '02',
    ...
    {
        path: ':theme/diagram/userhandle', component: UserHandlediagramComponent,
        name: 'User Handles',
        category: 'User Interaction', order: '02',
    ...
    },
    {
        ...
        name: 'Serialization',
        category: 'Print and Export', order: '03',
    ...
    },
    {
        ...
        category: 'Automatic Layouts', order: '04',
    ...
    {
        path: ':theme/diagram/organizationalchart', component: OrganizationalChartDiagramComponent,
    ...
    {
        path: ':theme/diagram/symmetriclayout', component: SymmetricLayoutDiagramComponent,
    ...
    {
        path: ':theme/diagram/rtl-tree', component: RTLTreeDiagramComponent,
        name: 'RTL Tree',
        category: 'Automatic Layouts', order: '04',
    ...
    },
    {
        ...
        name: 'Local Data',
        category: 'Data Binding', order: '05',
    ...
    },
    {
        ...
        name: 'Venn Diagram',
        category: 'Static Diagram', order: '06',
        description: 'This sample visually represents the hotel booking reservation system. It is built with readymade BPMN shapes.',
    }, {
        path: ':theme/diagram/fishbone', component: FishboneDiagramComponent,
        name: 'Fishbone Diagram', type: 'new',
...
let declarations: Type<Object>[] = [FlowDiagramComponent, ShapesDiagramComponent, NodeDiagramComponent,
    ConnectorDiagramComponent, AnnotationDiagramComponent, PortDiagramComponent,
    ...
    SerializationDiagramComponent, PrintExportDiagramComponent,
    ...
    PertChartDiagramComponent, BPMNShapesDiagramComponent, FishboneDiagramComponent
];
@NgModule({
    imports: [diagramRouter, DiagramAllModule, SymbolPaletteAllModule, OverviewAllModule, ButtonModule,
        ColorPickerModule, CheckBoxModule, ToolbarModule, DropDownButtonModule, UploaderModule,
