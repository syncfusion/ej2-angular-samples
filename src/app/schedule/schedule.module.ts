...
export const scheduleRouteConfig: Object[] = [
  ...
  { 'path': ':theme/schedule/resource', component: ResourceComponent, name: 'Resources', order: '06', category: 'Multiple Resources', description: 'This example depicts how to show or hide the resource events on JavaScript Scheduler based on the resource selection.' },
  ...
  { 'path': ':theme/schedule/adaptive-rows', component: AdaptiveRowsComponent, name: 'Row Auto Height', order: '06', category: 'Multiple Resources', description: 'This example showcases how the work cells of Essential JS2 Scheduler auto adjusts its height based on the exceeding appointment count.' },
