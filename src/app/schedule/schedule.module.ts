...
export const scheduleRouteConfig: Record<string, any>[] = [
  ...
  { path: ':theme/schedule/event-calendar', component: EventCalendarComponent, name: 'Event Calendar', order: '15', category: 'Product Use Case', type: 'new', description: 'This demo shows the way to organize and filter multiple types of events such as Personal, Birthdays, Work, and Holidays in the Angular scheduler.' },
  { path: ':theme/schedule/holiday-calendar', component: HolidayCalendarComponent, name: 'Holiday Calendar', order: '15', category: 'Product Use Case', type: 'new', description: 'This demo illustrates how to add and remove holiday events and perform CRUD operations on holiday dates in the Angular scheduler.' },
  ...
  { path: ':theme/schedule/schedule-to-schedule', component: MultipleSchedulerComponent, name: 'Multiple schedulers', order: '04', category: 'Drag and Drop', type:'new', description: 'This example illustrates how to drag and drop events among multiple schedules. You can drag and drop events from one schedule to another in the Angular Scheduler.' },
  { path: ':theme/schedule/grid-to-schedule', component: EventsGridFromScheduleComponent, name: 'Drag Events From DataGrid', order: '04', category: 'Drag and Drop', type:'new', description: 'This example illustrates how to drag and drop events between the DataGrid and the schedule. You can drag and drop events from the schedule to the DataGrid and from the DataGrid to in the Angular Scheduler.' },
  ...
  { path: ':theme/schedule/keyboard-interaction', component: KeyboardComponent, name: 'Keyboard Interaction', type:'update' , hideOnDevice: true, order: '13', category: 'Miscellaneous', description: 'This demo showcases all the available keyboard shortcuts that help users perform actions using only the keyboard in the Angular Scheduler control.' },
