...
export const scheduleRouteConfig: Record<string, any>[] = [
  ...
  { path: ':theme/schedule/virtual-scrolling', component: VirtualScrollingComponent, name: 'Virtual Scrolling', order: '04', category: 'Scrolling', hideOnDevice: true, type: 'update', description: 'This example illustrates how to achieve high performance in the Angular Scheduler using virtual scrolling to load resources and events on demand.' },
  ...
  { path: ':theme/schedule/custom-month-view', component: CustomMonthViewComponent, name: 'Custom Month View', order: '05', category: 'Views', description: 'This example showcases how to customize the starting week of the month and also customize the number of weeks to be rendered in month view with Angular Scheduler.' },
  ...
  { path: ':theme/schedule/reminder', component: ReminderComponent, name: 'Reminder', order: '10', category: 'Customization', description: 'This demo showcases an event reminder notification that will be displayed after 5 seconds of sample getting loaded.' },
