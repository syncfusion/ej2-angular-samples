...
export const scheduleRouteConfig: Record<string, any>[] = [
  ...
  { path: ':theme/schedule/custom-month-view', component: CustomMonthViewComponent, name: 'Custom Month View', order: '05', category: 'Views', type: 'new', description: 'This example showcases how to customize the starting week of the month and also customize the number of weeks to be rendered in month view with Angular Scheduler.' },
  ...
  { path: ':theme/schedule/excel-export', component: ExcelExportComponent, name: 'Excel Exporting', order: '13', category: 'Exporting', type: 'update', description: 'This example demonstrates how to export Angular Scheduler events (appointments) to the Microsoft Excel file format on the client side.' },
