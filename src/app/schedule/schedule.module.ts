...
export const scheduleRouteConfig: Record<string, any>[] = [
  ...
  { path: ':theme/schedule/data-virtualization', component: DataVirtualizationComponent , name: 'Data Virtualization', order: '04', hideOnDevice: true, description: 'This example illustrates how to load events on demand in Angular Scheduler' },
  ...
  { path: ':theme/schedule/events-template', component: EventsTemplateComponent, name: 'Events', order: '08', category: 'Template', description: 'This demo shows how to customize the look and feel of appointments (events) in the Angular Scheduler with images and links by using an event template.' },
