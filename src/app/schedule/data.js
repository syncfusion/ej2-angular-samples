...
export var resourceConferenceData = [
    {
        Id: 1,
        Subject: 'Burning Man',
...
export function generateObject(start, end, isWeekDaysOnly) {
...
export var quickInfoTemplateData = [
    {
        RoomId: 10,
        Id: 1,
        Subject: 'Board Meeting',
