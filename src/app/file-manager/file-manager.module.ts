...
export const fileManagerAppRoutes: Object[] = [
    ...
    { path: ':theme/file-manager/default', component: DefaultFileController, name: 'API', order: '01', type: 'update', category: 'File Manager', description: 'Angular FileManager component with how to render the File Manager without the navigation pane and enable or disable toolbar dynamically.' },
