...
export var orderData = JSON.parse(stringData, ɵ0);
...
export var data = orderData.map(ɵ1);
...
export var orderDetails = JSON.parse(order, ɵ2);
var templateDetails = employeeData;
...
export var employeeDetails = templateDetails;
var ɵ3 = function (field, value) {
    var dupValue = value;
    if (typeof value === 'string' && /^(\d{4}\-\d\d\-\d\d([tT][\d:\.]*){1})([zZ]|([+\-])(\d\d):?(\d\d))?$/.test(value)) {
        var arr = dupValue.split(/[^0-9]/);
...
export var orderDataSource = JSON.parse(purchaseData, ɵ3);
var ɵ4 = function (item) {
    var name1 = customerData.filter(function (cItem) {
        return cItem.CustomerID === item.CustomerID;
    })[0];
    item.CustomerName = (name1 || {}).ContactName;
    return item;
};
export var data1 = orderDataSource.map(ɵ4);
/**
 * Hierarchy Order data source
 */
export var hierarchyOrderdata = [
    {
