...
export const chartAppRoutes: Object[] = [
 ...
 order: '01', category: 'Line Charts' },
    ...
    { path: ':theme/chart/spline-range-area', component: SplineRangeAreaComponent, name: 'Spline Range Area', description: "This demo for Essential JS2 Chart control shows how to render the spline range area series.", order: '02', category: 'Area Charts' },
    ...
    { path: ':theme/chart/grouped-column', component: GroupedColumnChartComponent, name: 'Grouped Column', description: "This demo sample for Essential JavaScript2 Chart control demonstrates how to render and configure the grouping in column series.", order: '03', category: 'Bar Charts' },
    ...
    { path: ':theme/chart/rtl', component: RTLChartComponent, name: 'RTL', description: "This demo sample for Essential JavaScript2 Chart control demonstrates how to render and configure the RTL feature in chart.", order: '13', category: 'Chart Customization' },
