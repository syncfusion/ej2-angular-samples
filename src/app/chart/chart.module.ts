...
export const chartAppRoutes: Object[] = [
 ...
 order: '02', category: 'Line Charts' },
    ...
    { path: ':theme/chart/stacked-line', component: StackedLineChartComponent, name: 'Stacked Line', description: "This demo for Essential JS2 Chart control shows how to render the stacking line series.", order: '02', category: 'Line Charts' },
    { path: ':theme/chart/stacked-line-percent', component: PercentStackedLineChartComponent, name: '100% Stacked Line', description: "This demo for Essential JS2 Chart control shows how to render the 100 percent stacking line series.", order: '02', category: 'Line Charts' },
    ...
    { path: ':theme/chart/grouped-column', component: GroupedColumnChartComponent, name: 'Grouped Column', description: "This demo sample for Essential JavaScript2 Chart control demonstrates how to render and configure the grouping in column series.", order: '04', category: 'Bar Charts' },
    { path: ':theme/chart/rounded-column', component: RoundedColumnChartComponent, name: 'Rounded Column',description: "This demo for Essential JS2 Chart control shows how to render the rounded column series.", order: '04', category: 'Bar Charts' },
    ...
    { path: ':theme/chart/cylindrical-column', component: CylindricalColumnChartComponent, name: 'Cylindrical Column', description: "This demo for Essential JS2 Chart control shows how to render the cylindrical column series.", order: '04', category: 'Bar Charts' },
    ...
    { path: ':theme/chart/hilo-open-close', component: HiloOpenCloseChartComponent, description: "This demo for Essential JS2 Chart control shows how to render the hilo open close series.", name: 'Hilo Open Close', order: '05', category: 'Stock Charts' },
    { path: ':theme/chart/candle-stick', component: CandleStickChartComponent, name: 'Candle Stick', description: "This demo for Essential JS2 Chart control shows how to render the candle series.", order: '05', category: 'Stock Charts' },
    ...
    { path: ':theme/chart/donut', component: DonutComponent, name: 'Donut', description: "This demo for Essential JS2 Chart control shows how to render and configure the doughnut charts.", order: '07', category: 'Accumulation Charts' },
    ...
    { path: ':theme/chart/polar-area', component: PolarAreaChartComponent, name: 'Area', description: "This demo for Essential JS2 Chart control shows how to render area in polar and radar charts.", order: '11', category: 'Polar Radar' },
    { path: ':theme/chart/polar-stacking-area', component: PolarStackedAreaChartComponent, name: 'Stacked Area', description: "This demo for Essential JS2 Chart control shows how to render stacking area in polar and radar charts.", order: '11', category: 'Polar Radar' },
    { path: ':theme/chart/polar-scatter', component: PolarScatterChartComponent, name: 'Scatter', description: "This demo for Essential JS2 Chart control shows how to render scatter in polar and radar charts.", order: '11', category: 'Polar Radar' },
    { path: ':theme/chart/polar-column', component: PolarColumnChartComponent, name: 'Column', description: "This demo for Essential JS2 Chart control shows how to render column in polar and radar charts.", order: '11', category: 'Polar Radar' },
    { path: ':theme/chart/polar-stacking-column', component: PolarStackedColumnChartComponent, name: 'Wind Rose', description: "This demo for Essential JS2 Chart control shows how to render wind rose using stacking column in polar and radar charts.", order: '11', category: 'Polar Radar' },
    { path: ':theme/chart/polar-range-column', component: PolarRangeColumnChartComponent, name: 'Range Column', description: "This demo for Essential JS2 Chart control shows how to render range column in polar and radar charts.", order: '11', category: 'Polar Radar' },
    ...
    { path: ':theme/chart/category', component: CategoryChartComponent, name: 'Category Axis', description: "This demo for Essential JS2 Chart control shows how to render the category axis in charts.", order: '13', category: 'Chart Axes' },
    { path: ':theme/chart/date-time-category', component: DateTimeCategoryAxisChartComponent, name: 'DateTime Category Axis', description: "This demo for Essential JS2 Chart control shows how to render the date-time category axis in charts.", order: '13', category: 'Chart Axes' },
    { path: ':theme/chart/indexed-axis', component: IndexedAxisChartComponent, name: 'Indexed Category Axis', description: "This demo for Essential JS2 Chart control shows how to render the indexed category axis in charts.", order: '13', category: 'Chart Axes' },
    ...
    { path: ':theme/chart/axes-crossing', component: AxisCrossingChartComponent, name: 'Axes Crossing', description: "This demo for Essential JS2 Chart control demonstrates the axis crossing behavior in chart.", order: '13', category: 'Chart Axes' },
    ...
    { path: ':theme/chart/synchronized-chart', component: SynchronizedChartsComponent, name: 'Synchronized Charts', description: "This demo for Essential JS2 Chart control shows how to render the Synchronized Charts.", order: '14', category: 'Chart Customization' },
    ...
    { path: ':theme/chart/vertical', component: VerticalChartComponent, name: 'Vertical Chart', description: "This demo for Essential JS2 Chart control shows how to render and configure the vertical type charts.", order: '14', category: 'Chart Customization' },
    { path: ':theme/chart/empty-point', component: EmptyPointChartComponent, name: 'Empty Points', description: "This demo for Essential JS2 Chart control shows how to render and configure the empty points.", order: '14', category: 'Chart Customization'},
