...
export const toolbarAppRoutes: Object[] = [
    { path: ':theme/toolbar/default', component: DefaultToolbarComponent, name: 'Default Functionalities', type: 'update', description: 'The sample demonstrates the default functionalities of the Toolbar component which place commands with the scrollable mode in Angular platform.', category: 'Toolbar' },
    ...
    { path: ':theme/toolbar/template', component: TemplateToolbarComponent, name: 'Template', type: 'new', description: 'The sample demonstrates the customizing toolbar with other components using the template functionalities.', category: 'Toolbar' },
