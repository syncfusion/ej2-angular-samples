...
export const carouselAppRoutes: Object[] = [
  ...
  { path: ':theme/carousel/indicator-type', component: CarouselIndicatorComponent, name: 'Indicator Type', description: 'This example showcases the available indicator types and its functionalities in Syncfusion JavaScript Carousel component.', category: 'Carousel' },
