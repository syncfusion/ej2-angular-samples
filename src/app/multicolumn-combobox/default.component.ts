...
import { ChangeEventArgs, MultiColumnComboBoxComponent, MultiColumnComboBoxModule } from '@syncfusion/ej2-angular-multicolumn-combobox';
@Component({
...
export class DefaultMultiComboBoxComponent {
    ...
    public fields: Object = { text: 'ShipCountry', value: 'OrderID' };
    // set the value to select an item based on mapped value at initial rendering
    public value: string = '1001';
    // set the value to select an item based on mapped value at initial rendering
    public text: string = 'France';
    // set the placeholder to MultiColumn ComboBox input element
    public waterMark: string = 'Select the country';
