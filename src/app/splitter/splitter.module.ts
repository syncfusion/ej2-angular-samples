...
@NgModule({
    imports: [splitterRouter, ButtonModule, TreeViewModule, RichTextEditorModule, SplitterModule, SharedModule,CommonModule, TextBoxModule, ListViewAllModule, AccordionAllModule],
    declarations: [
