...
export const breadcrumbAppRoutes: Object[] = [
    ...
    { path: ':theme/breadcrumb/bind-to-location', component: BindToLocationController, type: 'update', name: 'Bind to Location', order: '01', category: 'Breadcrumb', description: 'This example demonstrates the binding of current url location to the items and items based on static url of Syncfusion Angular Breadcrumb component.' },
    ...
    { path: ':theme/breadcrumb/overflow-modes', component: OverFlowModesController, type: 'new', name: 'Overflow Modes', order: '01', category: 'Breadcrumb', description: 'This sample demonstrates the different types of overflow mode such as Hidden, Menu, Wrap, Collapsed, and Scroll in the Breadcrumb component.' },
