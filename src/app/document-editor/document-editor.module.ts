...
export const documentEditorAppRoutes: Object[] = [
    ...
    { path: ':theme/document-editor/print', component: PrintComponent, name: 'Print', order: '04', type: 'update', category: 'Print', description: "The Document Editor component is used to view and print Word documents in web applications by injecting only the modules that are necessary." },
