...
export const documentEditorAppRoutes: Object[] = [
    ...
    { path: ':theme/document-editor/bindUI-to-document', component: BindUIDocumentComponent, name: 'Bind UI To Document', order: '01', category: 'DocumentEditor',type: 'new', description: "The Document Editor component in Angular platform is used to create, edit, view, and print Word documents in web applications." },
    ...
    { path: ':theme/document-editor/heading-navigation', component: HeadingNavigationComponent, name: 'Heading navigation', order: '10', category: 'View', description: "The Document Editor component supports ruler to set tab stops, margins, indents and move table borders." },
