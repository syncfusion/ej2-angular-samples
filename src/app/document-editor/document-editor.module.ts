...
export const documentEditorAppRoutes: Object[] = [
    ...
    { path: ':theme/document-editor/character-formatting', component: CharacterFormattingComponent, name: 'Character Formatting', order: '02', category: 'Editing Features', type: 'update', description: "The Document Editor supports character formatting such as bold, italic, underline, subscript, superscript, font color, and more." },
    ...
    { path: ':theme/document-editor/styles', component: StylesComponent, name: 'Styles', order: '02', category: 'Editing Features', type: 'update', description: "The Document Editor supports both built-in and custom styles for character format and paragraph format." },
    ...
    { path: ':theme/document-editor/headers-footers', component: HeadersFootersComponent, type: 'update', name: 'Headers and Footers', order: '02', category: 'Editing Features', description: "The Document Editor supports headers and footers. Different headers and footers can be added to the first page, odd pages, and even pages." },
    ...
    { path: ':theme/document-editor/document-protection', component: DocumentEditorProtectionComponent, name: 'Document Protection', order: '08', category: 'Security', type: 'update', description: "The Document Editor provides document protection supports to restrict the types of changes can be made to the document by a user/user group." },
    ...
    { path: ':theme/document-editor/comments', component: CommentsComponent, name: 'Comments', order: '10', category: 'Review', type: 'update', description: "The Document Editor component supports add and edit comments in a Word document for comment discussion." },
    ...
    { path: ':theme/document-editor/multiple-columns', component: MultipleColumnsComponent, name: 'Multiple Columns', order: '02', category: 'References', description: "The Document Editor supports add or remove columns." },
];
