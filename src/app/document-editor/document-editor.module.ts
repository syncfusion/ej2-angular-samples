...
export const documentEditorAppRoutes: Object[] = [
    ...
    { path: ':theme/document-editor/default', component: DocEditorComponent, name: 'Default functionalities', order: '01', type: 'update', category: 'DocumentEditor', description: "The Document Editor component is used to create, edit, view, and print Word documents in web applications." },
    { path: ':theme/document-editor/character-formatting', component: CharacterFormattingComponent, name: 'Character Formatting', order: '02', type: 'update', category: 'Editing Features', description: "The Document Editor supports character formatting such as bold, italic, underline, subscript, superscript, font color, and more." },
