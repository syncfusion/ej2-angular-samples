...
export const documentEditorAppRoutes: Object[] = [
    ...
    { path: ':theme/document-editor/paragraph-formatting', component: ParagraphFormattingComponent, type: 'update', name: 'Paragraph Formatting', order: '02', category: 'Editing Features', description: "The Document Editor supports paragraph formatting such as indentation, paragraph spacing, line spacing, and text alignment." },
    ...
    { path: ':theme/document-editor/right-to-left', component: RightToLeftComponent,type: 'update', name: 'Right to Left', order: '05', category: 'RTL', description: "The Document Editor component is used to create, edit, view, and print Word documents in web applications." },
    ...
    { path: ':theme/document-editor/track-changes', component: TrackChangesComponent, type: 'update', name: 'Track Changes', order: '10', category: 'Review', description: "The Document Editor component in JavaScript platform allows users to view, make changes and accept or reject them in a Word document." },
