...
export const documentEditorAppRoutes: Object[] = [
    ...
    { path: ':theme/document-editor/autoshapes', component: AutoShapesComponent, name: 'Auto Shapes', order: '10', category: 'Shapes',type: 'new', description: "The Document Editor component supports Auto shapes preservation." },
