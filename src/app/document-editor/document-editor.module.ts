...
export const documentEditorAppRoutes: Object[] = [
    ...
    { path: ':theme/document-editor/table-formatting', component: TableFormattingComponent, type: 'update',name: 'Table Formatting', order: '02', category: 'Editing Features', description: "The Document Editor supports table formatting such as cell margins, cell spacing, horizontal merge, vertical merge, border styles, background color, and more." },
