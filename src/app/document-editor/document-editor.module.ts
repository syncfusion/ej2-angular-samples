...
export const documentEditorAppRoutes: Object[] = [
    ...
    { path: ':theme/document-editor/comments', component: CommentsComponent, type: 'update', name: 'Comments', order: '10', category: 'Review',  description: "The Document Editor component supports add and edit comments in a Word document for comment discussion." },
