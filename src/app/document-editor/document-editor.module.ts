...
export const documentEditorAppRoutes: Object[] = [
    ...
    { path: ':theme/document-editor/default',type:'update', component: DocEditorComponent, name: 'Default functionalities', order: '01', category: 'DocumentEditor', description: "The Document Editor component is used to create, edit, view, and print Word documents in web applications." },
    ...
    { path: ':theme/document-editor/ribbon-customization', component: RibbonCustomizationComponent, name: 'Ribbon Customization', type:'new', order: '06', category: 'Customization', description: "The Document editor allows to customize the built-in ribbon for better editing experience." },
    ...
    { path: ':theme/document-editor/autoshapes', component: AutoShapesComponent, name: 'Auto Shapes', type:'update', order: '10', category: 'Shapes', description: "The Document Editor component supports Auto shapes and Groups shapes preservation." },
