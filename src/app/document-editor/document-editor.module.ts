...
export const documentEditorAppRoutes: Object[] = [
    ...
    { path: ':theme/document-editor/default', component: DocEditorComponent, name: 'Default functionalities', order: '01', category: 'DocumentEditor', type: 'update', description: "The Document Editor component is used to create, edit, view, and print Word documents in web applications." },
    ...
    { path: ':theme/document-editor/comments', component: CommentsComponent, name: 'Comments', order: '04', category: 'Review',type: 'update', description: "The Document Editor component supports add and edit comments in a Word document for comment discussion." },
    ...
    { path: ':theme/document-editor/color-picker-customization', component: ColorPickerCustomizationComponent, name: 'Color Picker Customization', order: '06', category: 'Customization',type: 'new', description: "The Document Editor component supports to to customize color picker in appearance." },
    ...
    { path: ':theme/document-editor/advancedExporting', component: ExportComponent, name: 'Advanced Exporting', order: '08', category: 'Exporting', type: 'new', description: "The Document Editor component is used to export the document to other formats like Pdf, Rtf, HTML, ODT, WordML etc. from document editor" },
    ...
    { path: ':theme/document-editor/ruler', component: RuleComponent, name: 'Ruler', order: '10', category: 'View', description: "The Document Editor component supports ruler to set tab stops, margins, indents and move table borders." },
    { path: ':theme/document-editor/heading-navigation', component: HeadingNavigationComponent, name: 'Heading navigation', order: '10', category: 'View', type: 'new', description: "The Document Editor component supports ruler to set tab stops, margins, indents and move table borders." },
    { path: ':theme/document-editor/character-formatting', component: CharacterFormattingComponent, name: 'Character Formatting', order: '11', category: 'Editing Features', description: "The Document Editor supports character formatting such as bold, italic, underline, subscript, superscript, font color, and more." },
    { path: ':theme/document-editor/paragraph-formatting', component: ParagraphFormattingComponent, name: 'Paragraph Formatting', order: '11', category: 'Editing Features', description: "The Document Editor supports paragraph formatting such as indentation, paragraph spacing, line spacing, and text alignment." },
    { path: ':theme/document-editor/styles', component: StylesComponent, name: 'Styles', order: '11', category: 'Editing Features', description: "The Document Editor supports both built-in and custom styles for character format and paragraph format." },
    { path: ':theme/document-editor/bullets-numbering', component: BulletsNumberingComponent, name: 'Bullets and Numbering', order: '11', category: 'Editing Features', description: "The Document Editor supports bullets and numbering. Both single list and multi-level lists can be added." },
    { path: ':theme/document-editor/links-bookmarks', component: HyperlinksBookmarksComponent, name: 'Hyperlinks and Bookmarks', order: '11', category: 'Editing Features', description: "The Document Editor supports hyperlinks and bookmarks. The link can be a file, mail, webpage, or bookmark." },
    { path: ':theme/document-editor/table-formatting', component: TableFormattingComponent, name: 'Table Formatting', order: '11', category: 'Editing Features', description: "The Document Editor supports table formatting such as cell margins, cell spacing, horizontal merge, vertical merge, border styles, background color, and more." },
    { path: ':theme/document-editor/section-formatting', component: SectionFormattingComponent, name: 'Section Formatting', order: '11', category: 'Editing Features', description: "The Document Editor supports section formatting such as page size, page margins, header distance, and footer distance." },
    { path: ':theme/document-editor/headers-footers', component: HeadersFootersComponent, name: 'Headers and Footers', order: '11', category: 'Editing Features', description: "The Document Editor supports headers and footers. Different headers and footers can be added to the first page, odd pages, and even pages." },
    { path: ':theme/document-editor/form-fields', component: FormFieldsComponent, name: 'Form Fields', order: '11', category: 'Editing Features', description: "The Document Editor component in JavaScript platform allows users to design and fill legacy form fields (text, check box, and drop down) in a Word document." },
    { path: ':theme/document-editor/multiple-columns', component: MultipleColumnsComponent, name: 'Multiple Columns', order: '11', category: 'References', description: "The Document Editor supports add or remove columns." },
    { path: ':theme/document-editor/chart', component: DocumentEditorChartComponent, name: 'Chart Preservation', order: '12', category: 'Charts', description: "The Document Editor supports chart preservation for users who use to view their business reports with intuitive graphical data visualization." },
];
