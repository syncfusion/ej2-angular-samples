...
export const dateTimePickerAppRoutes: Object[] = [
    ...
    { path: ':theme/datetimepicker/date-time-range', component: RangeDateTimePickerComponent, name: 'Date Range', type: 'update', description: 'Flexible DateTimePicker component for Typescript to restrict date selection from defined range of values like current month, past days, next week, future days', category: 'DateTimePicker' },
