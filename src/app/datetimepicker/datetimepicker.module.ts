...
export const dateTimePickerAppRoutes: Object[] = [
    ...
    { path: ':theme/datetimepicker/date-time-format', component: FormatDateTimePickerComponent, name: 'Format',  type: 'update', description: 'The InputFormats feature allows users to define multiple input formats, automatically converting typed values to the display format for a seamless experience.', category: 'DateTimePicker' },
