...
export const dropdowntreeAppRoutes: Object[] = [
    ...
    { path: ':theme/drop-down-tree/template', component: TemplateDropDownTreeComponent, name: 'Template',category: 'DropDown Tree', type: "update", description: 'This example demonstrates how to customize the appearance of each item in the Angular drop-down tree component pop-up item using the template.', order: '01'},
