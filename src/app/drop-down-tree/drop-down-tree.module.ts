...
export const dropdowntreeAppRoutes: Object[] = [
    ...
    { path: ':theme/drop-down-tree/filtering', component: FilteringDropDownTreeComponent, name: 'Filtering',category: 'DropDown Tree', description: 'This example demonstrates how the filtering functionalities works based on the typed characters in the Angular drop-down tree component.', order: '01', type: 'new'},
