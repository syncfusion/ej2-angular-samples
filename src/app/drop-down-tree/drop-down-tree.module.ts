...
export const dropdowntreeAppRoutes: Object[] = [
    ...
    { path: ':theme/drop-down-tree/custom-template', component: CustomTemplateDropDownTreeComponent, name: 'Custom Template',category: 'DropDown Tree', type: 'new', description: 'This example demonstrates how to customize the display text of the selected items in the Angular drop-down tree component using the customTemplate', order: '01'},
