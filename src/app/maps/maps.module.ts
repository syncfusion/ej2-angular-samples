...
export const mapAppRoutes: Object[] = [
    ...
    { path: ':theme/maps/osm-with-marker-clustering', component: MapsOsmWithMarkerClusterComponent, type:"new", name: 'OSM with Marker Clustering', order: '04', category: 'Map Providers', description: 'This demo for Essential<sup>®</sup> JS2 Maps control depicts the marker clustering in the OpenStreetMap.' },
