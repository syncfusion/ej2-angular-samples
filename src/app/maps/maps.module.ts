...
export const mapAppRoutes: Object[] = [
    ...
    { path: ':theme/maps/osm-with-legend', component: MapsOsmWithLegendComponent, name: 'OSM with Legend', order: '03', category: 'Map Providers', description: 'This demo for Essential JS2 Maps control depicts the markers and legend in the OpenStreetMap.' },
