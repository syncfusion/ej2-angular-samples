...
export const mapAppRoutes: Object[] = [
    ...
    { path: ':theme/maps/print', component: MapsPrintComponent, name: "Print", order: "05", type: "update", category: "Print and Export", description: 'This demo for Essential JS2 Maps control illustrates the printing functionality in the maps control.' },
    { path: ':theme/maps/export', component: MapsExportComponent, name: "Export", type: "update", order: "05", category: "Print and Export", description: 'This demo for Essential JS2 Maps control illustrates the exporting functionality in the maps control.' },
    ...
    { path: ':theme/maps/dynamicmarker', component: MapsDynamicMarkerComponent, name: "Dynamic marker", order: "06", category: "Use Cases", description: 'This demo for Essential JS2 Maps control visualizes the dynamically added the marker and navigation line.' },
    ...
    { path: ':theme/maps/sales-map', component: MapsSalesMapComponent, name: "Sales map", order: "06", category: "Use Cases", description: 'This demo for Essential JS2 Maps control demonstrates the rendering of normal geometry type shapes on the map.'  },
