...
export const mapAppRoutes: Object[] = [
    ...
    { path: ':theme/maps/clusteringmarker', component: MapsClusteringComponent, name: "Marker Clustering", order: "02", category: "Features", description: 'This demo for Essential JS2 Maps control indicates the create the marker cluster in more than one marker intersect' },
    ...
    { path: ':theme/maps/polygon', component: PolygonComponent, name: 'Polygon', order: '03', category: 'Polygon',  description: 'This demo for Essential JS2 Maps control depicts the polygon shape rendering over OSM map.' },
    ...
    { path: ':theme/maps/osm-with-legend', component: MapsOsmWithLegendComponent, name: 'OSM with Legend', order: '04', category: 'Map Providers', description: 'This demo for Essential JS2 Maps control depicts the markers and legend in the OpenStreetMap.' },
    { path: ':theme/maps/tooltip', component: MapsTooltipComponent, name: "Tooltip", order: "05", category: "User Interaction", description: 'This demo for Essential JS2 Maps control depicts the countries that were appeared in the finals of Cricket World Cup and their counts.' },
    { path: ':theme/maps/selection', component: MapsSelectionComponent, name: "Selection & Highlight", order: "05", category: "User Interaction", description: 'This demo for Essential JS2 Maps control visualizes USA president election results in the year 2016. Default and interactive are the two types of legend.' },
    { path: ':theme/maps/zooming', component: MapsZoomingComponent, name: "Zooming & Panning", order: "05", category: "User Interaction", description: 'This demo for Essential JS2 Maps control depicts the properties required to zoom and pan the rendered map.' },
    { path: ':theme/maps/programmatic-zoom', component: MapsProgrammaticZoomComponent, name: "Zoom to fit all the markers in maps", order: "04", category: "User Interaction", description: 'This demo for Essential JS2 Maps control demonstrates the rendering of normal geometry type shapes on the map.'  },
    { path: ':theme/maps/drilldown', component: MapsDrilldownComponent, name: "Drill Down", order: "05", category: "User Interaction", description: 'This demo for Essential JS2 Maps control demonstrates drill down with all the continents in the initial view and countries on drill.' },
    { path: ':theme/maps/print', component: MapsPrintComponent, name: "Print", order: "06", category: "Print and Export", description: 'This demo for Essential JS2 Maps control illustrates the printing functionality in the maps control.' },
    { path: ':theme/maps/export', component: MapsExportComponent, name: "Export", order: "06", category: "Print and Export", description: 'This demo for Essential JS2 Maps control illustrates the exporting functionality in the maps control.' },
    { path: ':theme/maps/heatmap', component: MapsHeatmapComponent, name: "Heat Map", order: "07", category: "Use Cases", description: 'This demo for Essential JS2 Maps control visualizes the state wise population of India in the year 2011. Color for states will be applied based on its value.'  },
    { path: ':theme/maps/curved-lines', component: MapsCurvedLinesComponent, name: "Flight routes", order: "07", category: "Use Cases", description: 'This demo for Essential JS2 Maps control demonstrates the flight routes from India to China using navigation lines feature.'  },
    { path: ':theme/maps/dynamicmarker', component: MapsDynamicMarkerComponent, name: "Dynamic marker", order: "07", category: "Use Cases", description: 'This demo for Essential JS2 Maps control visualizes the dynamically added the marker and navigation line.' },
    { path: ':theme/maps/earthquake', component: MapsEarthquakeComponent, name: "Earthquake indication", order: "07", category: "Use Cases", description: 'This demo for Essential JS2 Maps control demonstrates the earth quack occurred in Sumatra, Indonesia in the year 2009.'  },
    { path: ':theme/maps/highlight', component: MapsHighlightComponent, name: "Highlighted Region", order: "07", category: "Use Cases", description: 'This demo for Essential JS2 Maps control depicts the ATM populated areas in Oklahoma by highlighting the regions.'  },
    { path: ':theme/maps/cyber-attack-map', component: MapsCyberAttackComponent, name: "Cyber Attack Map", order: "07", category: "Use Cases", description: 'This demo for Essential JS2 Maps control visualizes the cyber attack.'  },
    { path: ':theme/maps/pie', component: MapsPieComponent, name: "Map with Pie chart", order: "07", category: "Use Cases", description: 'This demo for Essential JS2 Maps control visualizes the placing of pie charts on the maps using marker templates.'  },
    { path: ':theme/maps/map-with-slider', component: MapsWithSliderComponent, name: "Map with Slider", order: "07",  category: "Use Cases", description: 'This demo for Essential JS2 Maps control visualizes the maps using slider.'  },
    { path: ':theme/maps/sales-map', component: MapsSalesMapComponent, name: "Sales map", order: "07", category: "Use Cases", description: 'This demo for Essential JS2 Maps control demonstrates the rendering of normal geometry type shapes on the map.'  },
