...
export const mapAppRoutes: Object[] = [
    ...
    { path: ':theme/maps/dynamic-marker', component: MapsDynamicMarkerComponent, name: "Dynamic marker", order: "06", category: "Use Cases", description: 'This demo for Essential JS2 Maps control visualizes the dynamically added the marker and navigation line.' },
