...
var AnnotationDataSerive = /** @class */ (function () {
    function AnnotationDataSerive() {
    }
    AnnotationDataSerive.prototype.GetSubGauge1 = function () {
        var gauge1 = new CircularGauge({
            load: function (args) {
    ...
    return AnnotationDataSerive;
}());
export { AnnotationDataSerive };
