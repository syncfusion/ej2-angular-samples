...
export const circulargaugeAppRoutes: Object[] = [
    ...
    { path: ':theme/circular-gauge/gradient-color', component: GradientColorComponent , name: 'Gradient Color',  order: '01', category: 'Circular Gauge', description: 'This demo for Essential JS2 Circular Gauge control demonstrate the gradient support for pointers and ranges.'},
    ...
    { path: ':theme/circular-gauge/export', component: ExportComponent, name: 'Print & Export', order: '05', category: 'Export', description: 'This demo for Essential JS2 Circular Gauge control will print and export the circular gauge in a required format.'},
