...
export const circulargaugeAppRoutes: Object[] = [
    ...
    { path: ':theme/circular-gauge/label', component: LabelComponent, name: 'Ticks and Labels', order: '01', category: 'Circular Gauge', description: 'This demo for Essential JS2 Circular Gauge control shows various properties available to customize the ticks and labels of an axis.'},
    ...
    { path: ':theme/circular-gauge/legend', component: LegendComponent, name: 'Legend', order: '01',  category: 'Circular Gauge', description: 'This demo for Essential JS2 Circular Gauge control shows the properties required to customize the legend.'},
    { path: ':theme/circular-gauge/gradient-color', component: GradientColorComponent , name: 'Gradient Color',  order: '01', type: 'new', category: 'Circular Gauge', description: 'This demo for Essential JS2 Circular Gauge control demonstrate the gradient support for pointers and ranges.'},
    ...
    { path: ':theme/circular-gauge/user-interactions', component: UserInteractionComponent, name: 'Pointer & Ranges Drag', order: '04', category: 'User Interaction', description: 'This demo for Essential JS2 Circular Gauge control visualizes the pointer drag support and its options.'},
    ...
    { path: ':theme/circular-gauge/export', component: ExportComponent, name: 'Print & Export', type: 'update', order: '05', category: 'Export', description: 'This demo for Essential JS2 Circular Gauge control will print and export the circular gauge in a required format.'},
    { path: ':theme/circular-gauge/sample-data', component: SampleDataComponent , name: 'Data Sample', order: '06', category: 'Live', description: 'This demo for Essential JS2 Circular Gauge control demonstrates live data, along with the data grid control.'},
    { path: ':theme/circular-gauge/apple-watch-rings', component: AppleWatchComponent, name: 'Apple Watch Rings',  order: '06', category: 'Live', description: 'This demo for Essential JS2 Circular Gauge control demonstrates live data, along with the apple watch rings.'},
...
SemiCircleComponent, ArcGaugeComponent, GradientColorComponent, AppleWatchComponent, ExportComponent, SpeedometerComponent];
