...
export const circulargaugeAppRoutes: Object[] = [
    ...
    { path: ':theme/circular-gauge/semi-circular-gauge', type: 'update', component: SemiCircleComponent, name: 'Semi-circle Gauge',  order: '01', category: 'Circular Gauge', description: 'This demo for Essential JS2 Circular Gauge control shows the properties required to customize the pointers.'},
    ...
    { path: ':theme/circular-gauge/legend', component: LegendComponent, type: 'new', name: 'Legend', order: '01',  category: 'Circular Gauge', description: 'This demo for Essential JS2 Circular Gauge control shows the properties required to customize the legend.'},
    ...
    { path: ':theme/circular-gauge/tooltip', type: 'update', component: TooltipComponent, name: 'Tooltip', order: '04', category: 'User Interaction', description: 'This demo for Essential JS2 Circular Gauge control visualizes the tooltip template for circular gauge pointer.'},
    ...
    { path: ':theme/circular-gauge/apple-watch-rings', component: AppleWatchComponent, name: 'Apple Watch Rings',  order: '05', category: 'Live', description: 'This demo for Essential JS2 Circular Gauge control demonstrates live data, along with the apple watch rings.'},
