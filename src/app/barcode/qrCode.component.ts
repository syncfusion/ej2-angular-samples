...
@Component({
    ...
    standalone: true,
    imports: [SBActionDescriptionComponent, QRCodeGeneratorModule, TextBoxModule, NumericTextBoxModule, CheckBoxModule, ColorPickerModule, DropDownListModule, SBDescriptionComponent]
})
