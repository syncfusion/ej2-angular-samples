...
export const rteAppRoutes: Object[] = [
    ...
    { path: ':theme/rich-text-editor/types', component: ToolbarTypeComponent, name: 'Type', description: 'This demo demonstrates different types and behaviors of a toolbar used in the angular HTML Editor such as expand/collapse, multirow,floating and popup.', order: '04', category: 'Toolbar', type: 'update' },
    { path: ':theme/rich-text-editor/bottom-toolbar', component: BottomToolbarComponent, name: 'Bottom Toolbar', description: 'The demo demonstrates how to add special characters or symbols into the rich content in vue Rich Text Editor using a custom toolbar command.', order: '04', category: 'Toolbar', type: 'new' },
