...
export const rteAppRoutes: Object[] = [
    ...
    { path: ':theme/rich-text-editor/image', component: ImageComponent, name: 'Image', description: 'This demo explains how to insert images with a blob or base64 format, link to the images, image upload, rotate left/right, and more in angular WYSIWYG HTML Editor.', order: '01', category: 'Rich Text Editor', type: 'update'  },
