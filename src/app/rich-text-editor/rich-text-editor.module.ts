...
export const rteAppRoutes: Object[] = [
    ...
    { path: ':theme/rich-text-editor/smart-suggestion', component: MentionFormatIntegrationComponent, name: 'Smart Suggestion', description: 'This example demonstrates how to implement custom text formatting within the Rich Text Editor using the @mention component.', order: '02', category: 'Mention Integration' , type: 'New' },
    ...
    { path: ':theme/rich-text-editor/insert-emoticons', component: InsertEmoticonsComponent, name: 'Insert Emoticons', description: 'This demo demonstrates how to insert emoticons into the rich content in angular WYSIWYG HTML Editor using a custom tool in the editor toolbar.', order: '04', category: 'Custom Tool' },
    ...
    { path: ':theme/rich-text-editor/markdown-editor-preview', component: MarkdownPreviewComponent, name: 'Preview', description: 'This demo shows how to render a angular Markdown editor with LIVE preview for markdown content editing using a third-party library, "marked js".', order: '05', category: 'Markdown Editor' },
