...
export const rteAppRoutes: Object[] = [
    ...
    { path: ':theme/rich-text-editor/smart-suggestion', component: MentionFormatIntegrationComponent, name: 'Smart Suggestion', type : 'update', description: 'This example demonstrates how to implement custom text formatting within the Rich Text Editor using the @mention component.', order: '02', category: 'Mention Integration'},
    { path: ':theme/rich-text-editor/types', component: ToolbarTypeComponent, name: 'Type', type : 'update', description: 'This demo demonstrates different types and behaviors of a toolbar used in the angular HTML Editor such as expand/collapse, multirow, and floating.', order: '03', category: 'Toolbar' },
    { path: ':theme/rich-text-editor/quick-format-toolbar', component: FormatQuicktoolbarComponent, name: 'Quick Format Toolbar', type : 'new', description: 'This sample demonstrates the "Quick Format Toolbar" option in Rich Text Editor content. To select the text content inside the Rich Text Editor and open the quick format toolbar for editing the Rich Text Editor value.', order: '03', category: 'Toolbar' },
    { path: ':theme/rich-text-editor/insert-special-characters', component: InsertSpecialCharactersComponent, name: 'Insert Special Characters', description: 'This demo for Syncfusion angular rich text editor component shows the users to add their commands to the toolbar along with the built-in commands.', order: '04', category: 'Custom Tool' },
    { path: ':theme/rich-text-editor/markdown-editor', component: MarkdownDefaultComponent, name: 'Overview', description: 'This demo covers all supported features and functionalities of the JavaScript Markdown editor, which  is another mode of the angular Rich Text Editor.', order: '05', category: 'Markdown Editor'},
    { path: ':theme/rich-text-editor/markdown-editor-preview', component: MarkdownPreviewComponent, name: 'Preview', type : 'update', description: 'This demo shows how to render a angular Markdown editor with LIVE preview for markdown content editing using a third-party library, "marked js".', order: '05', category: 'Markdown Editor' },
    { path: ':theme/rich-text-editor/markdown-editor-custom-format', component: MarkdownCustomComponent, name: 'Custom Format', description: 'This demo explains how to convert markdown content (with the custom format) to valid HTML markup using Markdown-to-HTML of the markdown parser in angular', order: '05', category: 'Markdown Editor' },
    { path: ':theme/rich-text-editor/reactive-form', component: FormComponent, name: 'Reactive Form', description: 'This demo explains how to validate the content and track status using a reactive form of Angular with form group attribute in the Angular WYSIWYG editor.', order: '06', category: 'Forms' },
