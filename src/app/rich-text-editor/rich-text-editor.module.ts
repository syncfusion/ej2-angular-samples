...
export const rteAppRoutes: Object[] = [
    ...
    { path: ':theme/rich-text-editor/export-document', component: ExportDocumentComponent, name: 'Export to Word / PDF', description: 'This demo explains how to export the content of the Rich Text Editor to Word and PDF document formats using the Syncfusion Document processing libraries.', order: '02', category: 'Export / Import', type: 'update' },
    { path: ':theme/rich-text-editor/import-word', component: ImportWordRTEComponent, name: 'Import from Word', description: 'This demo explains how to import the content from Word document to the Rich Text Editor using the Syncfusion Document processing libraries.', order: '02', category: 'Export / Import', type: 'update' },
    ...
    { path: ':theme/rich-text-editor/smart-suggestion', component: SmartSuggestionComponent, name: 'Smart Suggestion', description: 'This demo explains to how to use the slash menu feature of the Rich Text Editor to apply formats, open dialogs easily.', order: '03', category: 'Mention Integration', type: 'update' },
