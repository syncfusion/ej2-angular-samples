...
export const rteAppRoutes: Object[] = [
    { path: ':theme/rich-text-editor/tools', component: FullFeatureComponent, name: 'Overview', description: 'This demo describes basic and advanced features of the angular rich text editor component (WYSIWYG HTML Editor) with all its tools and functionalities.', order: '01', category: 'Rich Text Editor', type: 'update'},
    ...
    { path: ':theme/rich-text-editor/format-painter', component: FormatPainterComponent, name: 'Format Painter', description: 'This demo explains how to use Format Painter feature of the Rich Text Editor Component.', order:'01', category:'Rich Text Editor', type: 'New' },
