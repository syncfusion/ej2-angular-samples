...
import { ExportWordRTEComponent } from './export-word.component';
...
export const rteAppRoutes: Object[] = [
    ...
    { path: ':theme/rich-text-editor/export-word', component: ExportWordRTEComponent,  name: 'Export to Word / PDF', description: 'This demo explains how to export the content of the Rich Text Editor to Word and PDF document formats using the Syncfusion Document processing libraries.', order: '02', category: 'Export / Import', type: 'new'},
    { path: ':theme/rich-text-editor/import-word', component: ImportWordRTEComponent, name: 'Import from Word', description: 'This demo explains how to import the content from Word document to the Rich Text Editor using the Syncfusion Document processing libraries.', order: '02', category: 'Export / Import', type: 'new'},
    ...
    { path: ':theme/rich-text-editor/smart-suggestion', component: MentionFormatIntegrationComponent, name: 'Smart Suggestion', description: 'This example demonstrates how to implement custom text formatting within the Rich Text Editor using the @mention component.', order: '03', category: 'Mention Integration'},
    ...
    { path: ':theme/rich-text-editor/markdown-editor', component: MarkdownDefaultComponent, name: 'Overview', description: 'This demo covers all supported features and functionalities of the JavaScript Markdown editor, which  is another mode of the angular Rich Text Editor.', order: '06', category: 'Markdown Editor'},
    { path: ':theme/rich-text-editor/markdown-editor-preview', component: MarkdownPreviewComponent, name: 'Preview', description: 'This demo shows how to render a angular Markdown editor with LIVE preview for markdown content editing using a third-party library, "marked js".', order: '06', category: 'Markdown Editor' },
    { path: ':theme/rich-text-editor/markdown-editor-custom-format', component: MarkdownCustomComponent, name: 'Custom Format', description: 'This demo explains how to convert markdown content (with the custom format) to valid HTML markup using Markdown-to-HTML of the markdown parser in angular', order: '06', category: 'Markdown Editor' },
