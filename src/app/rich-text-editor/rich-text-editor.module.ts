...
export const rteAppRoutes: Object[] = [
    ...
    { path: ':theme/rich-text-editor/ai-assistant', component: AIAssistantEditorComponent, name : 'AI Assistant', description: 'This demo showcases the Built in AI Assistant interface of the Rich Text Editor component.', order: '01', category: 'Rich Text Editor', type: 'new'},
