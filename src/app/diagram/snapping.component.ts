...
import { SBActionDescriptionComponent } from '../common/adp.component';
 ...
 export class SnappingComponent {
    ...
    //  public showGridLines = (document.getElementById('showGridLines') as any).ej2_instances[0];
    //  public snappToObject = (document.getElementById('snappingToObject') as any).ej2_instances[0];
     public created(args) {
