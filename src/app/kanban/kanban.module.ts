...
export const kanbanRouteConfig: Object[] = [
  ...
  { 'path': ':theme/kanban/default', component: DefaultComponent, name: 'Default Functionalities', order: '01', category: 'Kanban', type: 'update', description: 'This demo for Essential JS2 Kanban component shows how the flat Kanban looks like with its default set of minimal configurations.' },
  ...
  { 'path': ':theme/kanban/search-filter', component: SearchFilterComponent, name: 'Search and Filter Cards', order: '01', category: 'Kanban', type: 'new', description: 'The example demo shows how to filter the cards and make searching when more number of cards on a JavaScript Kanban board that helps you to focus.' },
  { 'path': ':theme/kanban/sorting', component: SortingComponent, name: 'Sorting Cards', order: '01', category: 'Kanban', type: 'new', description: 'The example demonstrates how to sort the cards in the ascending or descending based on the data source order or indexing or custom field on the Kanban board.' },
