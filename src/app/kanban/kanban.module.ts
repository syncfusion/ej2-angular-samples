...
export const kanbanRouteConfig: Object[] = [
  ...
  { 'path': ':theme/kanban/swimlane', component: SwimlaneComponent, name: 'Swimlane', type: 'update', order: '01', category: 'Kanban', description: 'The example explains how to configure swimlane and its related settings (sorting order, drag-and-drop, and more) in JavaScript Kanban board.' },
