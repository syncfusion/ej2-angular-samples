...
export const ribbonAppRoutes: Object[] = [
  ...
  { path: ':theme/ribbon/contextual', component: RibbonContextualTabComponent, name: 'Contextual Tabs', description: 'This sample demonstrates the contextual tab functionality of the Syncfusion Angular Ribbon component.', category: 'Ribbon' },
  ...
  { path: ':theme/ribbon/keytip', component: RibbonKeyTipComponent, name: 'Ribbon KeyTips', description: 'This sample demonstrates the keytip functionalities of the Syncfusion Angular Ribbon component.', category: 'Ribbon' },
  { path: ':theme/ribbon/gallery', component: RibbonGalleryComponent, name: 'Ribbon Gallery', description: 'This sample demonstrates the gallery feature of the Syncfusion Angular Ribbon component.', category: 'Ribbon' }
];
