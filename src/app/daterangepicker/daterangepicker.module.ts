...
export const dateRangePickerAppRoutes: Object[] = [
	...
	{ path: ':theme/daterangepicker/date-format', component: FormatComponent,type:'update', name: 'Format', description: 'Customizable DateRangePicker component for Angular with options to change date and time formats of preferred culture to provide more readability in UI', category: 'DateRangePicker' },
