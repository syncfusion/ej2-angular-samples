...
export const AIGridAppRoutes: Object[] = [
    { path: ':theme/ai-grid/assistive-grid', component: AssistiveGrid, name: 'Assistive Grid', description: 'This demo shows the AI Assistive Grid in Data Grid.', category: 'Data Grid', type: 'New' },
