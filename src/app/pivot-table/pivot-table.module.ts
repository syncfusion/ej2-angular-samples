...
export const pivottableRouteConfig: Object[] = [
    ...
    { 'path': ':theme/pivot-table/exporting', 'description': 'This demo for Essential<sup>®</sup> JS2 Pivot Table control demonstrate client-side exporting of the pivot table to Excel, CSV and PDF formats', component: ExportingComponent, 'name': 'Default Export', order: '14', category: 'Exporting', type: "update" },
