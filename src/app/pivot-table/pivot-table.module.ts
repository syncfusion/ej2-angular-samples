...
export const pivottableRouteConfig: Object[] = [
    ...
    { 'path': ':theme/pivot-table/local', 'description': 'This demo for Essential JS2 Pivot Table control demonstrate the basic rendering of the pivot table with local JSON and CSV data', component: LocalComponent, 'name': 'Local Data', order: '02', category: 'Data Binding', type: 'update' },
    { 'path': ':theme/pivot-table/remote', 'description': 'This demo for Essential JS2 Pivot Table control demonstrate the basic rendering of the pivot table with JSON and CSV remote data', component: RemoteComponent, 'name': 'Remote Data', order: '02', category: 'Data Binding', type: 'update' },
    ...
    { 'path': ':theme/pivot-table/label-filtering', 'description': 'This demo for Essential JS2 Pivot Table control demonstrate label filtering of field headers either by including or excluding them', component: LabelFilterComponent, 'name': 'Label Filtering', order: '07', category: 'Filtering' },
    { 'path': ':theme/pivot-table/value-filtering', 'description': 'This demo for Essential JS2 Pivot Table control demonstrate the filtering of field headers based on the grand total (value based)', component: ValueFilterComponent, 'name': 'Value Filtering', order: '07', category: 'Filtering' },
    { 'path': ':theme/pivot-table/virtual-scrolling', 'description': 'This demo for Essential JS2 Pivot Table control shows virtual scrolling option available vertically and horizontally to load large records with ease', component: VirtualScrollingComponent, 'name': 'Virtual Scrolling', order: '08', category: 'Scrolling' },
    { 'path': ':theme/pivot-table/cell-template', 'description': 'This demo for Essential JS2 Pivot Table control demonstrate cell template option on cells of the pivot table', component: CellTemplateComponent, 'name': 'Cell Template', order: '09', category: 'Customization' },
    { 'path': ':theme/pivot-table/drill-through', 'description': 'This demo for Essential JS2 Pivot Table control shows the raw items of any value cells in pivot table', component: DrillThroughComponent, 'name': 'Drill Through', 'order': '10', 'category': 'Miscellaneous' },
    { 'path': ':theme/pivot-table/editing', 'description': 'This demo for Essential JS2 Pivot Table control allows to edit, add and delete the value cells in pivot table', component: EditingComponent, 'name': 'Editing', 'order': '10', 'category': 'Miscellaneous' },
    { 'path': ':theme/pivot-table/hyper-link', 'description': 'This demo for Essential JS2 Pivot Table control shows hyperlink option on cells of the pivot table', component: HyperLinkComponent, 'name': 'Hyperlink', order: '10', category: 'Miscellaneous' },
    { 'path': ':theme/pivot-table/defer-update', 'description': 'This demo for Essential JS2 Pivot Table control demonstrate defer layout update feature of the pivot table', component: DeferUpdateComponent, 'name': 'Defer Layout Update', order: '10', category: 'Miscellaneous' },
