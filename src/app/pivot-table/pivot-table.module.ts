...
export const pivottableRouteConfig: Object[] = [
    ...
    { 'path': ':theme/pivot-table/calculated-field', 'description': 'This demo for Essential JS2 Pivot Table control shows calculated field, and it allows users to add calculated items', component: CalculatedFieldComponent, 'name': 'Calculated Field', order: '05', category: 'Formula',  type: 'update' },
