...
export const pivottableRouteConfig: Object[] = [
    ...
    { 'path': ':theme/pivot-table/sparkline', 'description': 'This sample demonstrates how to embed sparkline charts inside Pivot Table cells to provide a visual representation of trends.', component: SparklineComponent, 'name': 'Sparkline Chart', order: '04', type: 'new', category: 'Integration' },
    ...
    { 'path': ':theme/pivot-table/external-data-based-filtering', 'description': 'This sample demonstrates how to externally filter data using a date range in the Pivot Table', component: ExternalDataBasedFilteringComponent, 'name': 'External Filtering', order: '09', type: 'new', category: 'Filtering' },
    ...
    { 'path': ':theme/pivot-table/pivot-table-exporting', 'description': 'This demo for Essential<sup>®</sup> JS2 Pivot Table control demonstrate server-side exporting of the pivot table to Excel, CSV and PDF formats', component: PivotTableExportComponent, 'name': 'Export as Pivot', type: 'new', order: '14', category: 'Exporting' }
];
