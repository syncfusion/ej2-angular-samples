...
export const pivottableRouteConfig: Object[] = [
    ...
    { 'path': ':theme/pivot-table/live-data', 'type': 'new', 'description': 'This sample demonstrates how frequently the pivot table and the pivot chart are updated with real-time data at a given time interval.', 'name': 'Live Data', component: LiveDataComponent, order: '01', category: 'Pivot Table' },
    ...
    { 'path': ':theme/pivot-table/performance', 'type': 'new', 'description': 'This sample demonstrates how the pivot table loads a large amount of data with ease using virtual scrolling.', 'name': 'Performance', component: PerformanceComponent, order: '03', category: 'Benchmark' }, 
    ...
    { 'path': ':theme/pivot-table/heat-map', 'type': 'new', 'description': 'In this sample, we show you how to visualize the bound data by making the pivot table cells look like a heatmap.', component: HeatMapComponent, 'name': 'HeatMap', order: '04', category: 'Integration'},
    { 'path': ':theme/pivot-table/field-list', 'description': 'This demo for Essential JS2 Pivot Table control demonstrate the field list feature of the pivot table', component: FieldListComponent, 'name': 'Field List', order: '05', category: 'User Interaction' },
    { 'path': ':theme/pivot-table/grouping-bar', 'description': 'This demo for Essential JS2 Pivot Table control demonstrate the grouping bar feature of the pivot table', component: GroupingBarComponent, 'name': 'Grouping Bar', order: '05', category: 'User Interaction' },
    ...
    { 'path': ':theme/pivot-table/selection', 'description': 'This demo for Essential JS2 Pivot Table control demonstrate the cell selection feature', component: SelectionComponent, 'name': 'Selection', order: '05', category: 'User Interaction' },
    { 'path': ':theme/pivot-table/Drill-Down', 'description': 'This demo for Essential JS2 Pivot Table control demonstrate the drill down feature of the pivot table', component: DrillDownComponent, 'name': 'Drill Down', order: '05', category: 'User Interaction' },
    { 'path': ':theme/pivot-table/summary-customization', 'description': 'This demo for Essential JS2 Pivot Table control demonstrate the summary customization feature of the pivot table', component: SummaryCustomizationComponent, 'name': 'Show/Hide Totals', order: '05', category: 'User Interaction' },
    { 'path': ':theme/pivot-table/grouping', 'description': 'This demo for Essential JS2 Pivot Table control demonstrate the grouping feature for date and number fields', component: GroupingComponent, 'name': 'Grouping', order: '05', category: 'User Interaction' },
    { 'path': ':theme/pivot-table/toolbar', 'description': 'This demo for Essential JS2 Pivot Table control demonstrate the toolbar feature of the pivot table', component: ToolbarComponent, 'name': 'Toolbar', order: '05', category: 'User Interaction' },
    ...
    { 'path': ':theme/pivot-table/calculated-field', 'description': 'This demo for Essential JS2 Pivot Table control shows calculated field, and it allows users to add calculated items', component: CalculatedFieldComponent, 'name': 'Calculated Field', order: '07', category: 'Formula' },
    { 'path': ':theme/pivot-table/aggregation', 'description': 'This demo for Essential JS2 Pivot Table control shows different types of aggregation for value fields', component: AggregationComponent, 'name': 'Aggregation', order: '07', category: 'Formula' },
    { 'path': ':theme/pivot-table/sorting', 'description': 'This demo for Essential JS2 Pivot Table control shows ordering(sorting) of fields either in ascending or descending order', component: SortingComponent, 'name': 'Default Sorting', order: '08', category: 'Sorting' },
    { 'path': ':theme/pivot-table/custom-sorting', 'description': 'This demo for Essential JS2 Pivot Table control shows ordering(custom sorting) of fields either in ascending or descending order', component: CustomSortingComponent, 'name': 'Custom Sorting', order: '08', category: 'Sorting' },
    { 'path': ':theme/pivot-table/value-sorting', 'description': 'This demo for Essential JS2 Pivot Table control shows sorting values on column or row wise in ascending or descending order', component: ValueSortingComponent, 'name': 'Value Sorting', order: '08', category: 'Sorting' },
    ...
    { 'path': ':theme/pivot-table/editing', 'description': 'This demo for Essential JS2 Pivot Table control allows to edit, add and delete the value cells in pivot table', component: EditingComponent, 'name': 'Editing', 'order': '13', 'category': 'Miscellaneous' },
    { 'path': ':theme/pivot-table/hyper-link', 'description': 'This demo for Essential JS2 Pivot Table control shows hyperlink option on cells of the pivot table', component: HyperLinkComponent, 'name': 'Hyperlink', order: '13', category: 'Miscellaneous' },
    { 'path': ':theme/pivot-table/defer-update', 'description': 'This demo for Essential JS2 Pivot Table control demonstrate defer layout update feature of the pivot table', component: DeferUpdateComponent, 'name': 'Defer Layout Update', order: '13', category: 'Miscellaneous' },
