...
export const pivottableRouteConfig: Object[] = [
    ...
    { 'path': ':theme/pivot-table/classic-layout', 'type': 'new', 'description': 'This sample demonstrates the classic (also known as tabular) layout view option of the pivot table.', component: ClassicLayoutComponent, 'name': 'Classic Layout', order: '01', category: 'Pivot Table' },
