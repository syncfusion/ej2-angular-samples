...
export const pivottableRouteConfig: Object[] = [
    ...
    { 'path': ':theme/pivot-table/dynamic-binding', 'description': 'Pivot Table demo for dynamic data loading from JSON, CSV, and OLAP(XMLA) sources, with toolbar options to save and reload reports as JSON files.', component: DynamicBindingComponent, 'name': 'Dynamic Binding', type: 'new', order: '02', category: 'Data Binding' },
