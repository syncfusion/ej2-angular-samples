...
export const pivottableRouteConfig: Object[] = [
    ...
    { 'path': ':theme/pivot-table/server-side-aggregation', 'description': 'This sample demonstrates the ability to use an external pivot engine to bind and populate data from a remote service and display it in the pivot table.', component: ServerSideAggregationComponent, 'name': 'Server-side Aggregation', order: '02', category: 'Data Binding', type: 'update'},
    ...
    { 'path': ':theme/pivot-table/value-sorting', 'description': 'This demo for Essential<sup>®</sup> JS2 Pivot Table control shows sorting values on column or row wise in ascending or descending order', component: ValueSortingComponent, 'name': 'Value Sorting', order: '08', category: 'Sorting', type: 'update' },
