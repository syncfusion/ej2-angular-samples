...
export const dialogAppRoutes: Object[] = [
    ...
    { path: ':theme/dialog/resizable', type: 'update', component: ResizableDialogComponent, name: 'Resizable', category: 'Dialog', description: 'This example shows how to create resizable modal in the Angular dialog to change the size of a dialog efficiently and view its content more comfortably.' },
