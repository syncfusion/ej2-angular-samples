...
@NgModule({
    // tslint:disable-next-line:max-line-length
    imports: [SharedModule, documentEditorRouter, FormsModule, ToolbarModule, DropDownListAllModule, ColorPickerModule, SplitButtonModule, ComboBoxModule, TabModule, DocumentEditorAllModule, DropDownListModule, SliderModule, NumericTextBoxModule, CheckBoxModule, ButtonModule, DropDownButtonModule, DialogModule, BrowserModule],
    // tslint:disable-next-line:max-line-length
    declarations: [DocEditorComponent, CharacterFormattingComponent, ParagraphFormattingComponent, StylesComponent,
        ...
        HeadersFootersComponent, TableOfContentsComponent, PrintComponent],
