...
export const documentEditorAppRoutes: Object[] = [
    ...
    { path: ':theme/document-editor/default', component: DocEditorComponent, name: 'Default functionalities', type: 'update', order: '01', category: 'DocumentEditor', description: "The Document Editor component is used to create, edit, view, and print Word documents in web applications." },
    ...
    { path: ':theme/document-editor/right-to-left', component: RightToLeftComponent, name: 'Right to Left', type: 'new', order: '04', category: 'RTL', description: "The Document Editor component is used to create, edit, view, and print Word documents in web applications." }
];
...
@NgModule({
    ...
    declarations: [DocEditorComponent, CharacterFormattingComponent, ParagraphFormattingComponent, StylesComponent,
        ...
        HeadersFootersComponent, TableOfContentsComponent, PrintComponent, RightToLeftComponent],
