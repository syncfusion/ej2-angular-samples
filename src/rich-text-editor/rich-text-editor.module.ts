...
export const rteAppRoutes: Object[] = [
    ...
    { path: ':theme/rich-text-editor/markdown-editor', component: MarkdownDefaultComponent, name: 'Overview', description: 'This demo for Syncfusion angular rich text editor component shows the markdown editing in the rich text editor with complete features.', order: '04', category: 'Markdown Editor', type: 'update' },
