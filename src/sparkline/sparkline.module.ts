...
export const sparklineAppRoutes: Object[] = [
    { path: ':theme/sparkline/default', component: DefaultSparklineComponent, name: 'Default', order: '01', category: 'Sparkline', description: 'This demo for Essential JS2 Sparkline control visualizes population, population density, population growth rate, and birth rate of various countries.' },
    { path: ':theme/sparkline/series-type', component: SeriesTypeSparklineComponent, name: 'Series Types', order: '01', 
    category: 'Sparkline', description: 'This demo for Essential JS2 Sparkline control depicts the various series types available in the sparkline.' },
    { path: ':theme/sparkline/axis-type', component: AxisTypeSparklineComponent, name: 'Axis value types',
     order: '01', category: 'Sparkline', description: 'This demo for Essential JS2 Sparkline control depicts the various axis types available in the sparkline.' },
    { path: ':theme/sparkline/sparkline-grid', component: SparklineGridSample, name: 'Sparkline in Grid',
     order: '01', category: 'Sparkline', description: 'This demo for Essential JS2 Sparkline control demonstrates rendering sparklines in the data grid control.' },
    { path: ':theme/sparkline/customization', component: SparklineCustomizationSample, name: 'Customization',
     order: '01', category: 'Sparkline', description: 'This demo for Essential JS2 Sparkline control depicts the properties required to customize the sparkline.' },
    { path: ':theme/sparkline/live-update', component: SparkineLiveUpdateSample, name: 'Live Update', order: '01', category: 'Sparkline', description: 'This demo for Essential JS2 Sparkline control depicts the task manager with live data update for sparklines.' },
    { path: ':theme/sparkline/range-band', component: SparklineRangebandSample, name: 'Range Band', order: '01', category: 'Sparkline', description: 'This demo for Essential JS2 Sparkline control depicts the range band feature and its customization options.' }
];
