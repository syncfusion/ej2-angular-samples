...
export const gridRouteConfig: Object[] = [
    ...
    {
        'path': ':theme/grid/column/stacked-header', component: StackedHeaderComponent, type:"update",
    ...
    },
    {
        ...
        category: 'Exporting', type: 'update'
    },
    {
