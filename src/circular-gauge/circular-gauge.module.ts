...
export const circulargaugeAppRoutes: Object[] = [
    ...
    { path: ':theme/circular-gauge/range', component: RangeComponent, name: 'Range', order: '01', category: 'Circular Gauge', type: 'update', description: 'This demo for Essential JS2 Circular Gauge control illustrates how to highlight specific regions in an axis by using ranges.' },
