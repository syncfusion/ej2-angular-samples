...
export const circulargaugeAppRoutes: Object[] = [
    ...
    { path: ':theme/circular-gauge/semi-circular-gauge', component: SemiCircleComponent, name: 'Semi-circle Gauge', type: 'new', order: '01', category: 'Circular Gauge', description: 'This demo for Essential JS2 Circular Gauge control shows the properties required to customize the pointers.'},
    { path: ':theme/circular-gauge/arc-gauge', component: ArcGaugeComponent, name: 'Arc Gauge', type: 'new', order: '01',  category: 'Circular Gauge', description: 'This demo for Essential JS2 Circular Gauge control shows the properties required to customize the pointers.'},
    ...
    { path: ':theme/circular-gauge/speedometer', component: SpeedometerComponent , name: 'Speedometer', type: 'new', order: '05', category: 'Live', description: 'This demo for Essential JS2 Circular Gauge control demonstrates live data, along with the data grid control.'}
];
...
SemiCircleComponent, ArcGaugeComponent, SpeedometerComponent];
