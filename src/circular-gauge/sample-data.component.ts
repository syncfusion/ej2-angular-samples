...
export class SampleDataComponent {
    ...
    public annotation1: string = "<div id='templateWrap'><img class='imageStyle' src='src/circular-gauge/images/positive.png' />" +
    ...
    public annotation5: string = "<div id='templateWrap'><img class='imageStyle' src='src/circular-gauge/images/negative.png' />" +
    "<div class='fontDes'>${pointers[0].value}%</div></div></div>";


    public germanyAnnotation: Object[] = [{
        content:  "<div id='templateWrap'>"
        +"<img style='width: 16px;height: 16px;margin-top: 4px;' src='src/circular-gauge/images/positive.png' />" 
    ...
    public ukAnnotation: Object[] = [{
        content:  "<div id='templateWrap'>"
        +"<img style='width: 16px;height: 16px;margin-top: 4px;' src='src/circular-gauge/images/negative.png' />" 
        + "<div style='float: right;color: #424242;font-size: 20px;'>${pointers[0].value}%</div></div></div>",
        angle: 180,
        radius: '30%'
    }, {
