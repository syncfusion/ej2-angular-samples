...
let regionColor: string[] = ['rgba(255, 64, 129, 0.3)', ' rgba(0, 120, 151, 0.3)',
    ...
    export class RangeNavigatorExportComponent {
        ...
        public theme: string = <ChartTheme>(selectedTheme.charAt(0).toUpperCase() + selectedTheme.slice(1));
        ...
        public onClick(e: Event): void {
            ...
            this.rangeNavigator.export(<ExportType>this.exportType.value, fileName, null,[this.rangeNavigator, this.chart]);
        };
